...
334. **[NEW] Add "Kup na cognivia.eu" badge to mobile hamburger menu on all pages** — Currently buy badge only in hero sections. Add to mobile nav dropdown so every page has a visible buy path on mobile (60%+ traffic). Green pill matching hero badge style. Estimated: 20 minutes.

335. **[NEW] Create "Jak suplementy wpływają na koncentrację? Kompletny przewodnik 2026" evergreen SEO article** — Long-form (3000+ words) authority article targeting "suplementy na koncentrację" (8K+ monthly searches in Poland). Covers: neuroscience of concentration, top 5 ingredients, how to choose, CogniCit positioning. Designed to rank #1. Includes FAQ schema, comparison tables. Estimated: 4 hours.
